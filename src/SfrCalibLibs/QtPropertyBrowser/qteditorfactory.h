...
class QTPROPERTYBROWSER_EXPORT QtPathEditorFactory:public QtAbstractEditorFactory<QtPathPropertyManager>
{
    Q_OBJECT
public:
    ...
    ~QtPathEditorFactory();
protected:
    void connectPropertyManager(QtPathPropertyManager *manager);
    QWidget *createEditor(QtPathPropertyManager *manager, QtProperty *property,
                QWidget *parent);
    void disconnectPropertyManager(QtPathPropertyManager *manager);
private:
