...
namespace Calibrator
{
    ...
    namespace LineScanner
    {
        ...
        bool algorithm::Simultaneous_Calib(std::vector<Eigen::Matrix4f> htm_end2base, 
            ...
            if (solve_method_ == SolveMethod::ITERATION){
                ...
                do{
                    ...
                    Rx_init = Calibrator::Utils::rodrigues(delta_R) * Rx_init;
        ...
        void algorithm::construct_linear_equation_iter(Eigen::Matrix3f Rx_init, Eigen::Vector3f tx_init,
            ...
            {
                // allocate data
                Calibrator::Utils::HomogeneousMtr2RT(mtr_end2base_[i], Ra_i, ta_i);
                Calibrator::Utils::HomogeneousMtr2RT(mtr_end2base_[i-1], Ra_j, ta_j);
                tsc_i = ctr_pnts_[i];
                tsc_j = ctr_pnts_[i-1];
                ...
                F_Ri = -Ra_i * Calibrator::Utils::skew(Rx_init * tsc_i)+ 
                       Ra_j * Calibrator::Utils::skew(Rx_init * tsc_j);
                F_ti = Ra_i - Ra_j;
        ...
        Eigen::Matrix3f algorithm::rota_schmidt_orth(Eigen::Matrix3f r_mat){
            ...
            if (!Calibrator::Utils::isRotatedMatrix(r_orth_mat))
                exit(-1);
