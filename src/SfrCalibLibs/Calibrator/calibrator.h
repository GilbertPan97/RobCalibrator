...
namespace Calibrator
{
    namespace LineScanner
    {
        class HandEyeCalib {
        private:
            Calibrator::CalibObj calib_obj_;
            Calibrator::CalibType type_;
        ...
        public:
            ...
            HandEyeCalib(Calibrator::CalibType type);
            ...
            bool SetObjData(std::vector<cv::Point3f> pnts_data, Calibrator::CalibObj obj);
